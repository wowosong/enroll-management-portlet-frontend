            ...
            <el-form :model="formData" :rules="rules" ref="ruleForm" label-width="172px">
                ...
                <el-form-item label="获奖信息:" label-width="82px">
                    <table class="table_list">
                        ...
                        <tr>
                            <td><el-date-picker type="date" placeholder="选择日期"></el-date-picker></el-input></td>
                            <td><el-input placeholder="限20个字"></el-input></td>
                            <td><el-input placeholder="限10个字"></el-input></td>
                        </tr>
                    </table>
                </el-form-item>
